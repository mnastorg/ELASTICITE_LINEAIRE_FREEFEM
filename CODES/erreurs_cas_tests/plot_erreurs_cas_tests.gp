...
set ylabel "erreur"
set title "Erreur DEPLACEMENTS en fonction du pas de maillage"
set key bottom right
set output "erreur_deplacement.pdf"
plot "cas_test1.txt" u 1:2 w lp ls 1 t 'Cas 1', "cas_test2.txt" u 1:2 w lp ls 2 t 'Cas 2', "cas_test3.txt" u 1:2 w lp ls 3 t 'Cas 3'

set ylabel "erreur"
set title "Erreur DEFORMATIONS en fonction du pas de maillage"
set key bottom right
set output "erreur_deformation.pdf"
plot "cas_test1.txt" u 1:3 w lp ls 1 t 'Cas 1', "cas_test2.txt" u 1:3 w lp ls 2 t 'Cas 2', "cas_test3.txt" u 1:3 w lp ls 3 t 'Cas 3'

set ylabel "erreur"
set title "Erreur CONTRAINTES en fonction du pas de maillage"
set key bottom right
set output "erreur_contraintes.pdf"
plot "cas_test1.txt" u 1:4 w lp ls 1 t 'Cas 1', "cas_test2.txt" u 1:4 w lp ls 2 t 'Cas 2', "cas_test3.txt" u 1:4 w lp ls 3 t 'Cas 3'

set ylabel "erreur"
set title "Erreur VON MISES en fonction du pas de maillage"
set key bottom right
set output "erreur_von_mises.pdf"
plot "cas_test1.txt" u 1:5 w lp ls 1 t 'Cas 1', "cas_test2.txt" u 1:5 w lp ls 2 t 'Cas 2', "cas_test3.txt" u 1:5 w lp ls 3 t 'Cas 3'
