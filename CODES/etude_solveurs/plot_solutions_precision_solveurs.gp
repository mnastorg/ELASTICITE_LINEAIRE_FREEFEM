...
set title "Erreur en fonction de la tolérance"
set key bottom right
set output "elast_precision_errors.pdf"
plot "resultats_precision_solveurs.txt" u 1:2 w lp ls 1 t 'UMFPACK' , "resultats_precision_solveurs.txt" u 1:4 w lp ls 2 t 'CG', "resultats_precision_solveurs.txt" u 1:6 w lp ls 3 t 'GMRES'

set ylabel "temps (s)"
set title "Temps CPU en fonction de la tolérance"
set key top right
set output "elast_precision_cpu.pdf"
plot "resultats_precision_solveurs.txt" u 1:3 w lp ls 1 t 'UMFPACK' , "resultats_precision_solveurs.txt" u 1:5 w lp ls 2 t 'CG', "resultats_precision_solveurs.txt" u 1:7 w lp ls 3 t 'GMRES'
