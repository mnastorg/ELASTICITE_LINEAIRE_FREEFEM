...
# term postscript eps enhanced color linewidth 2 font "Arial, 12"
#    size 10,6 inches
...
set ylabel "temps (s)"
set title "Temps CPU en fonction du pas de maillage"
set key top right
set output "elast_cpu_time.pdf"
plot "resultats_cpu.txt" u 1:3 w lp ls 1 t 'UMFPACK' , "resultats_cpu.txt" u 1:5 w lp ls 2 t 'CG', "resultats_cpu.txt" u 1:7 w lp ls 3 t 'GMRES'
